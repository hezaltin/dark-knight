export const fetchSchemaSuccess = {
  'brain:schemaType': 'grouped-edit-form',
  title: 'NBD Company Profile',
  description:
    'NBD company profile contains confidential information collected by and discussions witin the NBD team',
  groups: [
    { key: 'group--profile', name: 'Company Profile' },
    { key: 'group--updates', name: 'Team Updates' },
    { key: 'group--discussions', name: 'Discussion Summaries' },
    { key: 'group--documents', name: 'Team Documents' }
  ],
  schemas: {
    'group--profile': {
      __type__: 'group--profile',
      dataSchema: {
        type: 'object',
        title: 'NBD Company Profile',
        properties: {
            ...
            'brain:value': {
              ...
              'brain:valueSchemaDefinition': {
                ...
                asyncSingleObjectSelector: {
                  url:
                    '/api/value/typeahead-taxonomy-concepts/nbdCompany?limit=10&',
                  method: 'GET',
                  labelKey: 'label',
                  minLength: 0,
                  highlightOnlyResult: true,
                  attributes: [
                    { labelKey: 'country', title: null, col: 3 },
                    { labelKey: 'homepage', title: null, col: 9 }
                  ]
                }
              }
            },
            properties: {
              ...
              alsoKnownAs: {
                ...
                'brain:view': [
                  ...
                  { 'brain:viewType': 'view--profile', 'brain:viewOrder': 15 }
                ],
                items: { type: 'string' }
              }
            },
                ...
                name: {
                  ...
                  properties: {
                    ...
                    displayName: {
                      ...
                      'ml:constraint': [
                        {
                          'brain:search': { 'brain:searchType': 'range' },
          ...
          envelope_instance_content_info_status: {
            ...
            title: 'Status',
            properties: {
              score: { type: 'string', title: 'Status' },
              description: {
                type: 'string',
                'ml:index': [
                  {
            ...
            enum: [
              { score: '0', description: '0 - Not yet evaluated' },
              { score: '1', description: '1 - High interest, High Priority' },
              {
                score: '2',
                ...
                singleObjectSelector: {
                  ...
                  options: [
                    ...
                    },
                    {
                      score: '2',
                      description:
                        '2 - Potential interest for DWS, lower priority'
                    },
                    {
                      score: '3',
                      description:
                        '3 - No fit for DWS, but has potential for success'
                    },
                    {
                      score: '4',
                      description:
                  ...
                  labelKey: {
                    label: { fields: ['description'], separator: ' ' }
                  }
                },
          ...
          envelope_instance_content_info_submitter: {
            ...
            'brain:value': {
              ...
              'brain:valueSchemaTemplate': {
                'brain:valueSchemaTemplateName': 'ldapUserSearch',
                'brain:valueSchemaTemplateOptions': { multiple: false }
              }
            },
            properties: {
              id: { type: 'string' },
          ...
          envelope_instance_content_info_technologies: {
            ...
            items: {
              type: 'object',
              properties: {
                group: { type: 'string', title: 'Category' },
                item: { type: 'string', title: 'subCategory' }
              }
            },
            'brain:value': {
              'brain:valueType': 'attribute',
      ...
      uiSchema: {
        ...
        'brain:options': { 'brain:formSubmitButton': true },
        envelope_instance_content_info_title: {
          'ui:field': 'AsyncSingleObjectSelectorField',
          asyncSingleObjectSelector: {
        ...
        envelope_instance_content_info_champions: {
          ...
          asyncMultiObjectSelector: {
            ...
            allowNew: false,
            attributes: [
              { labelKey: ['id'], title: null, highlight: true, col: 1 },
              {
              ...
              { labelKey: ['organization', 'business'], title: null, col: 2 },
              { labelKey: ['organization', 'title'], title: null, col: 3 },
              {
                labelKey: {
                  label: {
                    fields: [
        ...
        envelope_instance_content_info_status: {
          ...
          singleObjectSelector: {
            ...
            labelKey: { label: { fields: ['description'], separator: ' ' } }
          },
          'ui:placeholder': 'Level of relevancy from 0 to 5'
        },
        envelope_instance_content_info_submitter: {
    ...
    'group--updates': {
      __type__: 'group--updates',
      dataSchema: {
        type: 'object',
        title: 'NBD Company Profile',
        properties: {
          envelope_instance_content_teamUpdates: {
            type: 'array',
            title: 'Team Update',
            'brain:group': { 'brain:groupOrder': 50 },
            items: {
              type: 'object',
              'brain:value': {
                'brain:valueType': 'data',
                'brain:valueSchemaTemplate': {
                  'brain:valueSchemaTemplateName': 'arrayItemRichTextEditor',
                  'brain:valueSchemaTemplateOptions': {}
                }
              },
              properties: {
            ...
            'brain:xpath':
              '/object-node("envelope")/object-node("instance")/object-node("content")/array-node("teamUpdates")'
          }
        }
      },
      uiSchema: {
        'ui:order': ['envelope_instance_content_teamUpdates'],
        'brain:options': { 'brain:formSubmitButton': false },
        envelope_instance_content_teamUpdates: {
          'ui:field': 'ArrayItemRichTextEditorField',
          arrayItemRichTextEditor: {}
        }
      }
    },
    'group--discussions': {
      __type__: 'group--discussions',
      dataSchema: {
        type: 'object',
        title: 'NBD Company Profile',
        properties: {
          envelope_instance_content_discussionSummaries: {
            type: 'array',
            title: 'Discussion Summaries',
            'brain:group': { 'brain:groupOrder': 60 },
            items: {
              type: 'object',
              'brain:value': {
                'brain:valueType': 'data',
            ...
            'brain:xpath':
              '/object-node("envelope")/object-node("instance")/object-node("content")/array-node("discussionSummaries")'
          }
        }
      },
      uiSchema: {
        'ui:order': ['envelope_instance_content_discussionSummaries'],
        'brain:options': { 'brain:formSubmitButton': false },
        envelope_instance_content_discussionSummaries: {
          'ui:field': 'ArrayItemRichTextEditorField',
          arrayItemRichTextEditor: {}
    ...
    'group--documents': {
      __type__: 'group--documents',
      dataSchema: {
        type: 'object',
        title: 'NBD Company Profile',
        properties: {
          envelope_attachments_documents: {
            type: 'array',
            title: 'Team Documents',
            'brain:value': {
              'brain:valueType': 'attribute',
              'brain:valueSchemaTemplate': {
                'brain:valueSchemaTemplateName': 'fileUploader',
                'brain:valueSchemaTemplateOptions': {}
              }
            },
            items: {
              ...
              properties: {
                ...
                type: { type: 'string', title: 'File Type' },
                size: { type: 'number', title: 'File Size' },
                modified: {
                  type: 'string',
                  format: 'date-time',
                  title: 'Modified Date'
            ...
            'brain:xpath':
              '/object-node("envelope")/object-node("attachments")/array-node("documents")'
          }
        }
      },
      uiSchema: {
        'ui:order': ['envelope_attachments_documents'],
        'brain:options': { 'brain:formSubmitButton': false },
        envelope_attachments_documents: {
